...
oecrm_require_admin_login();oecrm_require_csrf();oecrm_require_permission($conn,'clients','edit');
$id=oecrm_int_param($_GET,'deleteLeadSource');$companyId=oecrm_current_company_id($conn);
