                ...
                <form role="form" method="POST">
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="form-group" align="right">
                            <input class="btn btn-primary" type="submit" name="addFollowupType" value="Add Followup Type" style="margin-top: 7px;">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <br>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $qry = "SELECT * FROM followup_type_tbl";
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<td class="center" align="center"><a href="deleteFollowupType.php?deleteFollowupType=' . $row["id"] . '" onclick="return confirm(\'Are you sure you want to delete?\');"><i class="fa fa-trash-o" style="font-size:25px; color:red;"></i></a></td>';
                                                    echo "</tr>";
                                                }
                                            } else {
                                                echo "<tr><td>";
