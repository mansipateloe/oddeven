                                        ...
                                        <div class="perticulars">
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="bank_id[]" id="bank_id" required onchange="getPerson(this.value)" class="form-control">

                                                        <option value="">Select Payment</option>

                                                        <?php 

                                                            $qryProject = "SELECT * FROM bank_details order by bank_id desc";
                                                            ...
                                                            if($resultProject->num_rows > 0){
                                                                ...
                                                                while($resProject = $resultProject->fetch_assoc()){
                                                                    ...
                                                                    echo "<option value='".$resProject['bank_id']."'>".$resProject['bank_name']."</option>";
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="country_id[]" id="country_id" required onchange="getPerson(this.value)" class="form-control">
                                                ...
                                                if($invoice_result->num_rows > 0){
                                                    ...
                                                    while($invoice_row = $invoice_result->fetch_assoc()){
                                                        ...
                                                        echo "<tr class='gradeA even' role='row'>";
                                                            ...
                                                            <a type="button" data-toggle="modal" data-target="#myModal'.$invoice_row['invoice_id'].'"><i class="fa fa-money"></i></a>&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#add_more").click(function(){
            ...
            $("#perticulars_div").append('<div class="perticulars"><div class="col-lg-3"><div class="form-group"><label>Perticular :</label><input type="text" class="form-control" placeholder="Perticular" name="perticulars[]" required></div></div><div class="col-lg-2"><div class="form-group"><label>Payment :</label><select name="bank_id[]" id="bank_id" required onchange="getPerson(this.value)" class="form-control"><option value="">Select Payment</option> <?php $qryProject = "SELECT * FROM bank_details ORDER BY bank_id DESC";$resultProject = mysqli_query($conn, $qryProject);$bankOptions = '';if ($resultProject->num_rows > 0) {while ($resProject = $resultProject->fetch_assoc()) { echo '<option value="' . $resProject['bank_id'] . '">' . $resProject['bank_name'] . '</option>';} } ?></select></div></div><div class="col-lg-2"><div class="form-group"><label>Currency code :</label><select name="country_id[]" id="country_id" required onchange="getPerson(this.value)" class="form-control"><option value="">Select Code</option><?php 
