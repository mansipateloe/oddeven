                ...
                <?php
                    if(isset($_GET['id'])){
                        ...
                        if($invoice_result->num_rows > 0){
                            ...
                            $invoice_og_date = new DateTime($order['invoice_date']);
                            ?>
                            <div class="col-lg-12">
                                <div class="panel panel-default deposit_table">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-lg-12">
                                            <table>
                                                <tr>
                                                    <td class="firsttd" width="80%"><img src="../admin/img/logo.png" alt="logo" width="250px"></td>
                                                    <td class="secondtd" style="text-align: right;" width="20%">
                                            ...
                                            <!-- <div class="col-sm-6">
                                                    <img src="../admin/img/logo.png" alt="logo" width="250px">
                                            </div>
                                            <div class="col-sm-6">
                                                            ...
                                                            if($details_result->num_rows > 0){
                                                                ...
                                                                while($details_row = $details_result->fetch_assoc()){
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><i class="mdi mdi-currency-inr"></i><?php echo $details_row['amount'] ?></td>
                                                                    </tr>
                                                                    <?php 
                                                                }
                                                            }
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-md-6 text-right">
                                                <div class="float-right">
                                                    <h5>Total: <i class="mdi mdi-currency-inr"></i><?php echo $invoice_row['total_amount'] ?></h5>
                                                </div>
