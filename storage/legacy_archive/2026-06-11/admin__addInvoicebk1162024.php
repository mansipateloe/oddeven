                                    ...
                                    <table width="100%" id="invoice_tbl" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $i = 1;
                                                $amounts = 0;
                                                $invoice_qry = "SELECT invoiceTbl.*, projectsTbl.projectName FROM invoiceTbl left join projectsTbl on projectsTbl.id = invoiceTbl.project_Id order by invoiceTbl.invoice_date DESC";
