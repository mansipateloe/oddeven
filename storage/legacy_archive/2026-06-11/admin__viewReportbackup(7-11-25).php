                            ...
                            <?php 
                                ...
                                if($resultEmpName->num_rows > 0){
                                    while($rowEmpName = $resultEmpName->fetch_assoc()){
                                        if($_REQUEST['employeeId'] == $rowEmpName['id']){
...
echo '<td class="center" align="center">
    <a href="edit_report.php?edit='.$getDataRow["id"].'&employeeId='.$_REQUEST['employeeId'].'&month='.$_REQUEST['month'].'&year='.$_REQUEST['year'].'" style="display: inline-block;width: 28px;">
...
<!--    $(document).ready(function() {-->
<!--        var yearValue = "<?php echo $_REQUEST['year']?>";-->
<!--        if(yearValue == ""){-->
<!--            var d = new Date(),-->
<!--            year = d.getFullYear();-->
...
<!--<script type="text/javascript">-->
<!--    $(document).ready(function() {-->
<!--        var monthValue = "<?php echo $_REQUEST['month']?>";-->
<!--        if(monthValue == ""){-->
<!--            var v = new Date(),-->
<!--            month = v.getMonth()+1;-->
