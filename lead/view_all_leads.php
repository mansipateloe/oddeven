                            ...
                            <div class="col-sm-12">
                                 ...
                                 <div class="table-responsive m-t-15">
                                  ...
                                  <?php
									...
									{
										$select = "select * from cp_lead order by lid desc";
									} else {
										$select = "select * from cp_lead where exname='".$_SESSION['admin_id']."' order by lid desc";
									}
									...
									while($fetch = mysqli_fetch_array($query))
									{
									  ?>
									  <tr>
										<td class="text-center"><?php echo $fetch['srno']."-".$fetch['empcode']; ?></td>
