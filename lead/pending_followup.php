	...
	<div class="row">
       <div class="col-lg-12">
           <ul class="breadcrumb">
              ...
              <li><a href="#" class="active1">Pending Followup</a></li>
           </ul>
       </div>
    </div>
	<div class="row">
    	<div class="col-sm-12">
        	<div class="panel panel-flat">
					...
					<h5 class="panel-title">Pending Followup Data</h5>
                 </div>
		  		 <div class="panel-body">
                            <div class="col-sm-12">
                                 ...
                                 <div class="table-responsive m-t-15">
                                  ...
                                  <tbody>
                                  <?php
                                  		$query2 = "select lid from cp_lead_followup where fid IN (select max(fid) from cp_lead_followup group by lid) and nfdate < DATE(NOW()) ";
