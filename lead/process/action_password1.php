...
$sel = "select * from cp_users where uid='".$_SESSION['admin_login_id']."' and pass='".md5($old_pass)."'";
$qry = mysqli_query($conn,$sel);
$num = mysqli_num_rows($qry);
if($num > 0)
{
	$update = "update cp_users set pass='".md5($new_pass)."', password='".$new_pass."' where uid='".$_SESSION['admin_login_id']."'";
