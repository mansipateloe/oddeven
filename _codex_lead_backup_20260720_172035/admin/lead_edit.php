...
if ($id <= 0) {
    $_SESSION['lead_flash'] = 'Invalid lead selected.';
...
$leadStatus = ['close' => 'closed', 'complete' => 'completed'][$lead['status']] ?? $lead['status'];
?>
<div id="page-wrapper" class="compact-admin-page">
    ...
    <div class="panel panel-default lead-form-card">
        <div class="panel-heading"><strong>Lead Information</strong><span class="lead-status"><?php echo oecrm_h($leadStatus); ?></span></div>
